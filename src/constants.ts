export class Constants {
  ...
  //Maximum number of videos to list at a time
  public static VIDEO_LIST_MAX_RESULTS:number = 5;
  
  //Maximum number of comments to list at a time
  public static COMMENT_LIST_MAX_RESULTS:number = 10;
